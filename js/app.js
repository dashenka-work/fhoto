 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".work-block__slider")) new core(".work-block__slider", {
                ...
                navigation: {
                    prevEl: ".work-block__arrow-prev",
                    nextEl: ".work-block__arrow-next"
                }
            });
            if (document.querySelector(".locations-block__slider")) new core(".locations-block__slider", {
                modules: [ Navigation, Pagination, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
                ...
                loop: true,
                pagination: {
                    el: ".locations-block__pagination",
                    clickable: true
                },
                autoplay: {
                    delay: 4e3,
                ...
                navigation: {
                    prevEl: ".locations-block__arrow-prev",
                    nextEl: ".locations-block__arrow-next"
                }
            });
